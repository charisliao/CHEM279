...
int main() {
    ...
    // show steepest descent optimizer
    SteepestDescent steepest_descent(mol);
    steepest_descent.steepest_descent_optimizer(mol, 0.1, 0.0001, epsilon_i, epsilon_j, sigma_i, sigma_j);
